				...
				<div class="form-group">
					...
					<input type="tel" class="form-control" id="filetitle" name="phone_number" aria-describedby="fileTitleHelp" placeholder="Enter phone number" value="@if(isset($setting)) {{ $setting->emergency_number }} @endif">  
