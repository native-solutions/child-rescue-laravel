	...
	<div class="row">
		<div class="col-md-12">
			<div class="bgc-white bd bdrs-3 p-20 mB-20">
				<h4 class="c-grey-900 mB-20">All Slider Images
						<a href="{{ route('slider.create') }}" class="btn btn-info" style="float:right">Add new Image +</a>
				</h4>
				...
				<table class="table table-bordered">
					...
					<tbody>
						@if(sizeof($all_slider_images))
						@foreach($all_slider_images as $image)
						<tr>
							<th scope="row">1</th>
